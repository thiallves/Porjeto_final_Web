...
export class CouponController {
  ...
  @ApiQuery({ name: 'minDiscountPercent', required: false })
  @ApiQuery({ name: 'maxDiscountPercent', required: false })
  @ApiQuery({ name: 'expiresBefore', required: false })
  @ApiQuery({ name: 'expiresAfter', required: false })
  @ApiQuery({ name: 'isActive', required: false })
  findAll(@Query() query: FilterCouponsDto) {
  ...
  replace(@Param('id') id: string, @Body() dto: CreateCouponDto) {
